...
The majority of my high-quality mathematical exposition is done with [Math Advance](https://www.mathadvance.org). I strongly recommend you head over to [MAST](https://mast.mathadvance.org) in order to get better at math contests, and [MAC](https://mac.mathadvance.org) to take our contest.
