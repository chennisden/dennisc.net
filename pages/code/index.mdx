...
Otherwise, feel free to email me at [dchen@dennisc.net](mailto:dchen@dennisc.net). Discord or Hangouts work too, if you know how to reach me there.
...
- [palette](https://github.com/chennisden/palette)
    ...
    Provides tools to create and easily swap out color palettes. This package is meant for designers to use, since the API to switch palettes is user-friendly.
...
If you are in Math Advance, you will notice that the contest and book classes are not available here. While I am a big proponent of open source, I'd like to have some control over where our professional designs come up. If you want to study the code, please just let me know! I'm willing to send over snippets on an individual basis.
...
- [bounce.cls](https://github.com/chennisden/bounce)
    ...
    Each of the pieces of the class can be taken apart. For instance, if you want to import and use just the boxes, you can just `\usepackage{bounceboxes}`.
