...
const Home: FC<{}> = () => {
  return (
    <div className="self-center mx-12 sm:mx-28 md:max-w-screen-sm space-y-2">
      ...
      <p>This is my content that I think is most relevant, has been referenced more often, or have garnered the most interest.</p>
      <h3 className="text-xl font-bold">Math</h3>
      <ul>
        <Item name="Math Advance!" link="https://www.mathadvance.org">
          Math Advance! is the parent organization of MAC, the group behind the JMCs and MAT, and MAST, an online AIME training program modeled after Evan Chen's <Link href="https://web.evanchen.cc/otis.html">OTIS</Link>. This is the organization most people seem to know me for.
        </Item>
