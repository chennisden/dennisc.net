...
For the sake of argument, let's say that classes consist primary of the content you are taught. If you think about this carefully,
...
This is why you teach "hard" trigonometry (angle addition, et cetera) aloong with complex numbers. These concepts are identical, and once you can grasp that, both of them will be much easier to remember and use.
