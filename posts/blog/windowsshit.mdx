...
Windows is shit. It is absolutely, undeniably, irredeemably shit.[^noitisnt]
...
[^noitisnt]: I'm sure you could come up with a counterargument
	for each point I am about to make.
	I know that Powershell has grep-like functions,
	that you can disable Microsoft's spyware
	(just kidding, [you can't](https://www.computerworld.com/article/3159424/you-still-can-t-turn-off-windows-10-s-built-in-spyware.html)),
	hack together Windows' half-assed symlinks, whatever.

	But you're fighting the operating system the entire way.

	Now that I think about it, this is exactly
	what the education system feels like.
	I still *could* actively look for the truth
	about Christopher Columbus, for instance
	instead of blindly assuming he was
	a great explorer/genocidical maniac.
	
	But it is a lot *easier* when nobody is actively
	pushing the narrative for or against Columbus.
	It is a lot easier to learn delta-epsilon
	when your teacher is not actively convincing you
	that it is too hard or not crucial.

	I guess this sums up my issue with US education
	quite well.
	I would like to stop fighting against the school
	when I'm trying to learn about something,
	just like I don't want to fight with my machine
...
When it comes to, say, psychology,
...
When we get there,
the right approach is to give students *choice*[^choice]
in a modularized fashion.
But we are not there.
We are on Windows,
and Windows is shit.
So let's get off first.[^opinion]
[^choice]: It's a bit misleading to suggest
	you should choose your style of education
	the same way you choose between distros.
		
	You might have noticed a disconnect between
	what the smartest kids need from school
	and what the rest of the population want from it.
	This difference sort of is like the difference between different distros,
	but there are some key distinctions.

	The smartest students *should* be getting
	a different form of education compared to other people.
	I don't mean to imply any absolutes, but it is a lot more likely
	that gifted students should recieve gifted education
	(usually in the form of taking college classes).
	
	This implies a form of value judgment.
	That is, there is a distinguishable trait, "intelligence"
	that determines the type of education you should recieve.
	Whether this value judgment is correct, necessary, or accurate
	is a topic for another day.

	So it's not like I'm consciously choosing not to
	critically think about AP filler.
	It's just that I can't handle thinking about
	AP filler along with everything else on my plate,
	and the choice I have made is with what I am
	consciously thinking about.
	It is *bad* that I'm not thinking about AP filler,
	whereas it is not bad to use a more beginner-friendly distro.

[^opinion]: It doesn't actually matter whether you think
	staying on Windows is fine or not.
	Maybe you don't care how your computer functions
	and honestly, that is fine.
	It doesn't bother me that my keyboard is not ergonomic
	or that my mouse is a barely functional office mouse.
	But education is not something we can afford to just not care about.
	
	The *issues* with high school math education
	versus any decent contest or higher math class
	are similar to the issues with Windows versus Linux.
	But the *urgency* is not.
	
	Look at what half the nation thinks about *vaccines* and *masks*.

## Paradigms

Using Windows limits your perspective on what computers can do.
I'm not just talking about tools like grep, sed, and awk,
or your package manager (though package managers are very sexy).
What I'm referring to are *paradigms*.

There are people who know in the back of their head
that computers could *probably* perform X task.
But with what they have in front of them
they can't believe that it's possible.

For instance, you can export your settings via dotfiles.
This is something that is so obvious in hindsight,
and it's something someone just has to explicitly tell you.
Of course your settings are stored as text.
I mean, how else would they be stored?
The computer has to read them somehow.

This is what I mean when I am referring to paradigms.
Some people think settings are just knobs you screw around with on a GUI,
and other people think that settings are contained and adjusted in text files.
Both are valid ways of adjusting settings, so why is one paradigm better than the other?

Because one of them is more fundamental than the other.
It captures what is going on at a deeper level.
When you're changing some knobs on a GUI,
you're abstracting away the changing of text on a file.
Sometimes this abstraction is desireable. Sometimes it's necessary.
But it's important to understand you're making a tradeoff of understanding for convenience.

This is a big deal when it comes down to education, particularly mathematics.

In most Calculus BC classes, the idea of the limit is just abstracted away.
"A limit is the behavior of a function as it gets close to a value,"
your teacher says, though in much less precise terms.
And then you do a number of "high-level manipulations" with them,
like L'Hopitals or Taylor Series or whatever nonsense problem the exam throws at you.
But you still don't know what a limit is.
So you take all these fancy formulas and apply them blindly,
and Calculus becomes like every other math class you've taken in high school:
dreading the moment a problem comes up
and blindly applying the solution you found on Google.[^analogy]
[^analogy]: Just like when you have a problem on your machine,
think "Oh god, not again," and google an answer on Stack Overflow
and just paste it in.

In fact, the first math class you take at a college is usually aimed
towards rectifying these abstractions you're given in high school.[^group][^limits]

[^group]: Take group theory as an example. Most people don't really know what a remainder is.
	This is usually rectified when your abstract algebra class goes over groups.
	(You can verify that addition and multiplication under a modulus is a group.)
[^limits]: We've just discussed about limits.
	There's a lot of layers to unpeel here, actually.
	Generally, in the middle of precalculus or in the beginning of Calculus,
	you are told that a limit is what happens when you get close to something.
	Then you learn through delta-epsilon what "closer" really means,
	and you learn what it *really* means through topology.
...
to shift money into the hands of textbook publishers
who do not have our interests at heart,
and we aren't able to easily examine
...
you re-examine your teaching paradigms
or give your students freedom,
education won't be *fixed*.
But does that mean the answer is
continuing to blindly accept someone else's answers
on how you should be teaching
without thinking about them for yourself?
Does that mean the answer is stagnating and giving up?
I don't think so.

The problem isn't that teachers are bad, because they aren't.
Nor is it entirely with the school district or state.[^district]
...
[^district]: Though the district and state are often to blame for
	decisions that directly harm the welfare of students.
	How many times has California tried to get rid
	of accelerated math?